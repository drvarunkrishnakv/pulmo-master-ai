 ...
 */
export async function scrapeNEETSS(page: puppeteer.Page): Promise<ExamNotification | null> {
    try {
 ...
 */
export async function scrapeINISS(page: puppeteer.Page): Promise<ExamNotification | null> {
    try {
 ...
 */
export async function scrapeAllExams(): Promise<ExamNotification[]> {
